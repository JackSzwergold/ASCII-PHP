...
//**************************************************************************************//
// Now deal with the ascii helper class related stuff.
$asciiHelper = new asciiHelper();
$asciiHelper->controller = $controller;
$mosaic_html_content = $asciiHelper->renderContent($DEBUG_MODE);
...
$substitution_map['[[VIEW_MODE]]'] = $asciiHelper->VIEW_MODE;
